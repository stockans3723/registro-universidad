...
<html lang="en">
    ...
    <body>
        ...
        <section class="static_area">
            <div class="container">
                <h2 align="center">Selecione la tabla que desae modificar para mandar un nuevo resultado<br>Tambien puede crear correcciones ortograficas o gramaticales</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="static_main_content">
                                ...
                                <form class="contact_us_form row" action="actualizaReg.php".method="GET" id="from1" name="from1" novalidate="novalidate">
...
<input type="number" name="Celular" id="Celular"/>                             class="form-control"-->
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="submit" value="submit" class="btn submit_btn2 form-control" >Modificar</button>
                                    </div>
                                    <!--================End Banner Area =================-->
        <section >
            <div >
                ...
                <?php
                                ...
                                <form class="contact_us_form row" action="actualizaUsu.php".method="GET" id="from1" name="from1" novalidate="novalidate">

                                    <H3 align="center">Ingrese el ID de Usuario<br></H3>
                                    <br>
...
<input type="number" name="Celular" id="Celular"/>                             class="form-control"-->
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="text"  name="inden" placeholder="idUsuario"/>
                                    </div>
