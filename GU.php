                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <div class="contact_form">
                                ...
                                <form class="contact_us_form row" action="GuardarUsuario.php"  method="post" id="from1" name="from1" novalidate="novalidate">
...
<input type="number" name="Celular" id="Celular"/>                             class="form-control"-->
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="text"  id="idUsuario" name="idUsuario" placeholder="idUsuario"/>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="number"  id="CodigoPostal" name="CodigoPostal" placeholder="CodigoPostal"/>
                                    </div>
                                    <div class="form-group col-lg-12">
                                    ...
                                    <H5 align="center">El promedio debe ser entero y sin redondear </H5>
                                    <div class="form-group col-lg-12">
                                        <input type="number"  id="Promedio" name="Promedio" placeholder="Promedio"/>
                                    </div>
                                    <H3 align="center">Datos Medico</H3>
                                    <div class="form-group col-lg-12">
                                        <input type="text"  id="TipoSangre" name="TipoSangre" placeholder="TipoSangre"/>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text"  id="Discapacidad" name="Discapacidad" placeholder="Discapacidad"/>
                                    </div>
                                    <div class="form-group col-lg-12">
