            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="registros.php">Registros</a></li>
        ...
        <section class="main_slider_area">
            <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                <ul>
                    ...
                    <!-- MAIN IMAGE -->
                        <img src="img/home-slider/slider.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYER NR. 1 -->
                        <div class="slider_text_box">
                            ...
                            <div class="tp-caption tp-resizeme secand_text"
                                ...
                                style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Piensa, Evalua, Seleciona y Disfruta <br />La unica persona con el poder de cambiar tu destino eres tú
                            </div>
                    ...
                    <!-- MAIN IMAGE -->
                        ...
                        <div class="slider_text_box">
                            <div class="tp-caption tp-resizeme secand_text"
                                ...
                                style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Comienza tu camino<br />
                                Nosotros nos encargaremos de brindarte la informacion para iniciar tu viaje
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                <div class="main_title">
                                    <h2>Buscar la universidad adecuada  <br /> Con nosotros encontraras la mejor opción</h2>
                                </div>
                                <p>Con nosotros encontraras gran variedad de opciones que se ajustaran a las diferentes necesidades, este sara tu nuevo comienzo y como tal debes conocer las decisiones que tomaras para escribir tu propio destino por ello debes tomar la eleccion tomando en cuenta tus cualidades, actitudes y  habilidades, las cuales seran la herramientas que te guiaran en yu camino</p>
