...
$ident=$_GET['inden'];
echo "$ident";
$consulta = "SELECT * FROM registro WHERE idRegistro= '".$ident."'";
$Datos_registro = mysqli_query($conexion,$consulta) or die (mysqli_error());
$fila=mysqli_fetch_assoc($Datos_registro);
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="contact_form">
                                ...
                                <div class="main_title">
                                 ...
                                 <form class="contact_us_form row" action="GuardarActualizacionReg.php?registro=<?php echo $ident?>"  method="post" id="from1" name="from1" novalidate="novalidate">

                                    <H3 align="center">ID o nombre de Registro<br></H3>
                                    <br>
                                    <div class="form-group col-lg-12">
                                        <input type="text"  id="idRegistro" name="idRegistro" value="<?php echo $fila['idRegistro'];?>"/>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input list="Universidad" type="text"  id="idUniversidad" name="idUniversidad" value="<?php echo $fila['idUniversidad'];?>"/>
                                    ...
                                    <div  class="form-group col-lg-12">
                                        <input list="Carreras" type="text"  id="idCarreras" name="idCarreras" value="<?php echo $fila['idCarreras'];?>"/>
