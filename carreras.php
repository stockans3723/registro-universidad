            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="carreras.php">Carreras</a></li>
                        ...
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                <div class="main_title">
                                    <h4>La universidad de Salud y Bienestar cuenta con las siguientes carreras  <br /> aqui encontraras multiples opciones a elegir</h4>
                                </div>
                                <?php
                                //Enviamos la consulta a la base de datos seleccionada
                                $resultado=mysqli_query($conexion,'SELECT*FROM carreras1');
                                ?>
                                <table ALIGN=CENTER width="700" border="5">
                                ...
                                <p>Consulta mas informacion de esta universidad</p>
                                <a class="read_btn" href="Licenciaturas e Ingenierias.html">Informate</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="d_feature_img">
                                <img src="img/feature-right1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="digital_feature p_100">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                <div class="main_title">
                                    <h4>La universidad de Arte y cultura cuenta con las siguientes carreras  <br /> aqui encontraras multiples opciones a elegir</h4>
                                </div>
                                <?php
                                //Enviamos la consulta a la base de datos seleccionada
                                $resultado=mysqli_query($conexion,'SELECT*FROM carreras2');
                                ?>
                                <table ALIGN=CENTER width="700" border="5">
                        ...
                        <div class="col-lg-6">
                            <div class="d_feature_img">
                                <img src="img/feature-right2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="digital_feature p_100">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                <div class="main_title">
                                    <h4>La universidad de Ingenierias cuenta con las siguientes carreras  <br /> aqui encontraras multiples opciones a elegir</h4>
                                </div>
                                <?php
                                //Enviamos la consulta a la base de datos seleccionada
                                $resultado=mysqli_query($conexion,'SELECT*FROM carreras3');
                                ?>
                                <table ALIGN=CENTER width="700" border="5">
                        ...
                        <div class="col-lg-6">
                            <div class="d_feature_img">
                                <img src="img/feature-right3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="digital_feature p_100">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                <div class="main_title">
                                    <h4>La universidad de Licenciaturas cuenta con las siguientes carreras  <br /> aqui encontraras multiples opciones a elegir</h4>
                                </div>
                                <?php
                                //Enviamos la consulta a la base de datos seleccionada
                                $resultado=mysqli_query($conexion,'SELECT*FROM carreras4');
                                ?>
                                <table ALIGN=CENTER width="700" border="5">
                                ...
                                <p>Consulta mas informacion de esta universidad</p>
                                <a class="read_btn" href="">Informate</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="d_feature_img">
                                <img src="img/feature-right4.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
